...
FIELDS: list[Field] = [
    ...
    Field("razorpay_plan_abhyasi", "Payments (Razorpay)", "Plan ID — Abhyāsi", env_attr="razorpay_plan_abhyasi"),
    Field("razorpay_plan_sadhaka", "Payments (Razorpay)", "Plan ID — Sādhaka", env_attr="razorpay_plan_sadhaka"),
    # Meta Pixel / CAPI
